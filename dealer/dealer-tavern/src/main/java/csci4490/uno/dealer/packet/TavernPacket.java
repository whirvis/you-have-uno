...
public abstract class TavernPacket {
     ...
     */
    public @NotNull TavernPacket writeString(@NotNull String str) {
     ...
     */
    public @NotNull TavernPacket writeAddress(@NotNull InetSocketAddress address) {
     ...
     */
    public final @NotNull TavernPacket encode(@NotNull ByteBuf dest) {
     ...
     */
    public final @NotNull TavernPacket encodeAndSend(@NotNull TcpSession session) {
     ...
     */
    public final @NotNull TavernPacket decode(@NotNull ByteBuf src) {
